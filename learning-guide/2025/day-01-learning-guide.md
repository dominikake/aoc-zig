...
## Problem Breakdown
### Part 1: Track circular dial position, count final position landings on zero
### Part 2: Count ALL zero crossings during rotation steps, not just final positions
